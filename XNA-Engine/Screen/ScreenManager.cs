...
namespace Engine.Screen
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            blankTexture = ColorTextureGenerator.Create(GraphicsDevice, Color.Transparent);
        ...
        {
            Debug.WriteLine(string.Join(", ", screens.Select(screen => screen.GetType().Name).ToArray()));
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            foreach (var screen in screensToDraw.Where(screen => screen.ScreenState != ScreenState.Hidden))
